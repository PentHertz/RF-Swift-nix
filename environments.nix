...
# tool never breaks the whole shell.
{
  ...
  sdr_light = {
    ...
    category = "SDR";
    prerequisites = [
      "soapysdr-with-plugins" "soapyplutosdr" "soapyremote" "soapyuhd" "soapybladerf"
      "rtl-sdr-osmocom" "hackrf" "airspy" "airspyhf" "limesuite" "uhd"
      "libbladeRF" "libhydrasdr" "libiio" "libad9361" "osmo-fl2k" "libresdr-firmware"
      "signalhound-sdk" "harogic-htra-sdk"
    ];
    packages = [
      # SoapySDR + all its device plugins (rtlsdr, hackrf, uhd, airspy, bladerf, lime, plutosdr, remote, ...)
      "soapysdr-with-plugins"
      "soapyplutosdr" "soapyremote" "soapyuhd" "soapybladerf"
      ...
      "jupyter"
      "kc908"
      "signalhound-spike" "signalhound-vsg60" "sastudio"
    ];
  ...
  sdr_full = {
    ...
    packages = [
      ...
      "op25"
      "tetra-kit"
      "signalhound-spike" "signalhound-vsg60" "sastudio" "kc908"
    ];
  ...
  cyberether = {
    ...
    category = "SDR";
    prerequisites = [
      "soapysdr-with-plugins" "hackrf" "rtl-sdr-osmocom" "airspy" "limesuite" "uhd"
    ];
    packages = [
  ...
  wifi = {
    ...
    packages = [
      ...
      "iw"
      "ubertooth"
      "airgeddon" "airgorah" "asleap" "hostapd-mana" "freeradius" "horst" "chirp"
      "wacker" "wifipumpkin3" "sparrow-wifi"
      "macstealer" "fluxion" "fern-wifi-cracker"
      "wifiphisher"
      "eaphammer"
  ...
  network = {
    ...
    packages = [
      ...
      "burpsuite"
      # Web / recon / scanning
      "whatweb" "wafw00f" "nikto" "wpscan" "dirb" "gobuster" "ffuf" "feroxbuster"
      "nuclei" "httpx" "katana" "hakrawler" "waybackurls" "gowitness" "arjun"
      "dalfox" "commix" "xsstrike" "wfuzz" "graphqlmap" "gitleaks" "trufflehog"
      # Network scanning / discovery
      "masscan" "zmap" "rustscan" "naabu" "amass" "subfinder" "dnsx" "assetfinder"
      "dnstwist" "fping" "arp-scan" "netdiscover" "onesixtyone" "snmpcheck"
      "sniffnet" "trippy" "curlie" "sipvicious" "tcpflow" "dsniff"
      # Bruteforce / creds / AD
      "thc-hydra" "medusa" "ncrack" "netexec" "evil-winrm" "smbmap"
      "enum4linux-ng" "kerbrute" "certipy" "mitm6"
      # Pivoting / proxying / MITM
      "mitmproxy" "chisel" "ligolo-ng" "sshuttle" "proxychains-ng" "socat"
      "stunnel" "proxify" "sslscan"
      # More web/recon/exploit tooling + resources
      "caido" "routersploit" "dnsrecon" "fierce" "gospider" "joomscan" "testssl"
      "sipp" "exploitdb" "seclists" "payloadsallthethings" "enum4linux"
      "autorecon"
      "sstimap" "ssrfmap" "sippts" "hetty"
      "sslyze"
    ];
    missing = [ ];
  };
  ...
  reversing = {
    ...
    packages = [
      ...
      "gef" "ropgadget" "one_gadget" "checksec" "capstone" "rehex" "hexedit"
      # Static analysis / supply chain
      "flawz" "trivy" "grype" "syft" "gitleaks"
      # Forensics / firmware
      "volatility3" "foremost" "testdisk" "sleuthkit" "autopsy" "dc3dd" "ddrescue" "chntpw"
      "sasquatch" "kaitai-struct-compiler"
      "joern"
      "unblob"
      "x64dbg"
      "ollydbg"
  ...
  hardware = {
    ...
    packages = [
      ...
      "picocom"
      "minicom"
      "arduino-cli" "dfu-programmer" "gcc-arm-embedded" "platformio"
      "stlink" "teensy-loader-cli" "urjtag" "mtkclient"
      "scopehal-apps"
      "dsview"
      "saleae-logic2"
  ...
  osint = {
    ...
    packages = [
      ...
      "whois"
      "dnsutils"
      "amass" "subfinder" "dnsx" "dnstwist" "photon" "gitleaks" "trufflehog" "gowitness"
      "sublist3r"
      "spiderfoot"
    ];
    missing = [ ];
  ...
  android = {
    ...
    packages = [
      ...
      "dex2jar"
      "apksigner"
      "aapt" "apkeep" "apkleaks" "enjarify" "objection" "androguard"
      "drozer"
      "smali"
      "mobsf"
    ];
  ...
  ad = {
    ...
    packages = [
      ...
      "certipy" "mitm6" "evil-winrm" "smbmap" "enum4linux-ng" "certsync" "donpapi" "lsassy" "bloodyad"
    ];
    missing = [ ];
  };
  ...
  telecom = {
    ...
    category = "Telecom";
    prerequisites = [
      "libosmocore" "lksctp-tools" "soapysdr-with-plugins"
      "uhd" "limesuite" "hackrf"
    ];
    packages = [
